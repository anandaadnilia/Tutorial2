...
public class ActivityToogle extends Activity { ToggleButton tg1,tg2;
    ...
    protected void onCreate(Bundle savedInstanceState) { super.onCreate(savedInstanceState); setContentView(R.layout.activity_main);
        ...
        tg1=(ToggleButton) findViewById(R.id.button);
        tg2=(ToggleButton) findViewById(R.id.button2);

        b1=(Button)findViewById(R.id.button2); b1.setOnClickListener(new View.OnClickListener() {
            @Override
